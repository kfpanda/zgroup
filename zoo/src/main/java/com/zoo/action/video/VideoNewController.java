...
import com.zoo.service.VideoNewService;


@Controller
@RequestMapping(value = "/videoNew")
public class VideoNewController extends BaseAction {
    ...
    public String list() {
        return "/statics/html/videoNew.html";
    }
